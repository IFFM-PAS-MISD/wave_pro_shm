...
delam_el_div = 37; // number of nodes on the outer edge of delamination (for Transfinite Curve)
...
xpzt2 = L/4;
ypzt2 = W/4;
pzt_el_div = 25; // number of nodes on the outer edge of pzt (for Transfinite Curve)
//
...
Mesh.CharacteristicLengthFactor = 0.800000;
